...
Others: none
*************************************************/
void  DivideSector::SetOriginPoint(const pcl::PointXYZI & f_oPoint) {
...
Others: none
*************************************************/
std::vector<std::vector<GroundFeature> > DivideSector::ComputePointSectorIdxs(pcl::PointCloud<pcl::PointXYZI> vCloud,
