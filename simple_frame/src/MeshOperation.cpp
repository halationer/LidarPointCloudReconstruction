...
========================================*/
pcl::PointXYZI MeshOperation::ComputeFaceCenterPoint(const pcl::PointXYZI & oA, const pcl::PointXYZI & oB, const pcl::PointXYZI & oC){
...
Function: calculate the center point of each triangular face
========================================*/
pcl::PointXYZI MeshOperation::ComputeFaceCenterPoint(const pcl::PointCloud<pcl::PointXYZI> & vVertices){
...
========================================*/
void MeshOperation::LocalFaceNormal(const pcl::PointCloud<pcl::PointXYZI> & vVertices, const std::vector<pcl::Vertices> & vMeshVertexIdxs, const Eigen::MatrixXf & oMatNormal, pcl::PointCloud<pcl::PointNormal> & vCombinedNormal){
...
void MeshOperation::NormalMatrixToPCL(const pcl::PointCloud<pcl::PointXYZI> & vPoints, const Eigen::MatrixXf & oMatNormal, pcl::PointCloud<pcl::PointNormal> & vPointNormal, bool bReversed){
