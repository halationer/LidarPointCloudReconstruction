...
public:
	...
	void SetOriginPoint(const pcl::PointXYZI & f_oPoint);
	...
	std::vector<std::vector<GroundFeature> > ComputePointSectorIdxs(pcl::PointCloud<pcl::PointXYZI> vCloud,
...
//	pcl::PointCloud<pcl::PointXYZI>::Ptr vOneCloud(new pcl::PointCloud<pcl::PointXYZI>);
//	HPDpointclouddataread("_PC_1frame.las", vOneCloud, vOneFrame);
//
//	std::vector<Point3D> vRobotPoint;
//	pcl::PointCloud<pcl::PointXYZI>::Ptr vRobotCloud(new pcl::PointCloud<pcl::PointXYZI>);
