...
========================================*/
void ConvexHullOperation::ChangeNormalType(const pcl::PointCloud<pcl::PointXYZ> & vClouds, const std::vector<FacePara> & vFaceParams, pcl::PointCloud<pcl::PointNormal> & vPNormals){
...
========================================*/
pcl::Normal ConvexHullOperation::CaculateTriangleNormal(pcl::PointXYZ & oPZero, 
	                                              pcl::PointXYZ & oPOne,
	                                              pcl::PointXYZ & oPTwo){
...
========================================*/
void ConvexHullOperation::ComputeCenterPoint(const pcl::PointCloud<pcl::PointXYZ> & vVertices, const std::vector<pcl::Vertices> & vMeshVertexIdxs,
...
========================================*/
void ConvexHullOperation::ComputeCenterPoint(const pcl::PointCloud<pcl::PointXYZ> & vVertices, pcl::PointXYZ & oCenterPoint){
...
========================================*/
void ConvexHullOperation::ComputeAllFaceParams(const pcl::PointCloud<pcl::PointXYZ> & vVertices, 
...
========================================*/
void ConvexHullOperation::FaceParamInTwoSpace(const pcl::PointCloud<pcl::PointXYZ> & vConvertVertices,
	                                          const std::vector<pcl::Vertices> & vConvertMeshIdxs,
	                                          const pcl::PointCloud<pcl::PointXYZ> & vEuclidVertices,
...
std::vector<float> ConvexHullOperation::ComputePointSignedDis(const std::vector<SignedDis> & vConvexSD,
	const pcl::PointCloud<pcl::PointXYZ> & vQueryCloud,
...
the function computes the signed distance from each query point to the reconstructed surface
========================================*/
std::vector<float> ConvexHullOperation::ComputePointSignedDis(const pcl::PointCloud<pcl::PointXYZ> & vQueryCloud, const Eigen::MatrixXf & m_oMatN, const Eigen::VectorXf & m_vD){
...
========================================*/
std::vector<SignedDis> ConvexHullOperation::ComputePointSignedDis(pcl::PointCloud<pcl::PointXYZ> & vQueryCloud){
