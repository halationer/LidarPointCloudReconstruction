#include"HashVolume.h"

HashVolume::HashVolume(const pcl::PointCloud<pcl::PointXYZ> & vCloud)
...
========================================*/
void HashVolume::SetInitialNodeValue(float fDefault){
...
Function: Compute extrema of bounding box of input point clouds
========================================*/
void HashVolume::GetResolution(pcl::PointXYZ oLength){
...
Function: Compute extrema of bounding box of input point clouds
========================================*/
void HashVolume::SetExpandNum(float fExpandNum){
...
Function: Compute extrema of bounding box of input point clouds
========================================*/
int HashVolume::Tran3DIdxTo1D(const IndexinAxis & o3DIdx){
...
Function: Compute extrema of bounding box of input point clouds
========================================*/
IndexinAxis HashVolume::Tran1DIdxTo3D(const int & i1DIdx){
...
Function: Compute extrema of bounding box of input point clouds
========================================*/
void HashVolume::GetIntervalNum(int iVoxelNumX, int iVoxelNumY, int iVoxelNumZ){
...
int HashVolume::PointBelongVoxel(const PointType & oPoint){
...
template int HashVolume::PointBelongVoxel(const pcl::PointXYZ & oPoint);
template int HashVolume::PointBelongVoxel(const pcl::PointNormal & oPoint);
...
========================================*/
template<class PointType>
int HashVolume::PointBelongVoxel(const PointType & oPoint, IndexinAxis & oP3DIndex){
...
template int HashVolume::PointBelongVoxel(const pcl::PointXYZ & oPoint, IndexinAxis & oP3DIndex);
template int HashVolume::PointBelongVoxel(const pcl::PointNormal & oPoint, IndexinAxis & oP3DIndex);

template<>
int HashVolume::PointBelongVoxel(const Eigen::Vector3f & oPoint, IndexinAxis & oP3DIndex){
...
template<class PointType>
bool HashVolume::OutOfBorder(const PointType & oPoint) {
...
template<>
bool HashVolume::OutOfBorder(const Eigen::Vector3f & oPoint) {
	return oPoint.x() < 0 || oPoint.y() < 0 || oPoint.z() < 0 ||
		oPoint.x() >= m_iFinalVoxelNum.ixnum || oPoint.y() >= m_iFinalVoxelNum.iynum || oPoint.z() >= m_iFinalVoxelNum.iznum;
}
template<>
bool HashVolume::OutOfBorder(const IndexinAxis & oPoint) {
...
void HashVolume::VoxelizePoints(const pcl::PointCloud<pcl::PointXYZ> & vSampledCloud){
...
void HashVolume::VoxelizePoints(const pcl::PointCloud<pcl::PointNormal> & vSampledCloud){
...
void HashVolume::VoxelizePoints(const pcl::PointCloud<pcl::PointXYZ> & vSampledCloud, const pcl::PointCloud<pcl::PointXYZ> & vDenseCloud){
...
void HashVolume::OutputNonEmptyVoxels(std::vector<bool> & vVoxelStatus){
...
========================================*/
//compute a given point clouds belong to the corresponding voxel
//void HashVolume::FindNearNodes(const pcl::PointCloud<pcl::PointXYZ> & vCloud, pcl::PointCloud<pcl::PointXYZ> & vNearNodes){
//
//	//clear the voxel index
...
========================================*/
void HashVolume::CornerIdxs(const IndexinAxis & o3DIdx, std::vector<int> & vNeighborIdxs){
...
e.g.,
========================================*/
void HashVolume::ClearMiddleData(){
