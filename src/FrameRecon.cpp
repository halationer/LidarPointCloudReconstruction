...
FrameRecon::FrameRecon(ros::NodeHandle & node,
  ...
  m_oGroundSuber = nodeHandle.subscribe(m_sGroundTopic, 1, &FrameRecon::HandleGroundClouds, this);
  m_oBoundSuber = nodeHandle.subscribe(m_sBoundTopic, 1, &FrameRecon::HandleBoundClouds, this);
  m_oObstacleSuber = nodeHandle.subscribe(m_sObstacleTopic, 1, &FrameRecon::HandleObstacleClouds, this);
...
Calls: all member functions
Called By: FrameRecon(), which is the construction function 
Table Accessed: none
Table Updated: none
...
void FrameRecon::InitializeGridMap(const pcl::PointXYZ & oRobotPos) {
...
Others: none
*************************************************/
void FrameRecon::ExtractLabeledPCs(pcl::PointCloud<pcl::PointXYZ> & vNearGrndClouds,
...
Others: none
*************************************************/
void FrameRecon::SamplingPointClouds(pcl::PointCloud<pcl::PointXYZ>::Ptr & pCloud,
...
m_oOdomSuber = nodeHandle.subscribe(m_sOdomTopic, 1, &FrameRecon::HandleTrajectory, this);
this is the trigger functions and backbone functions of class FrameRecon
Calls: InitializeGridMap()
       OutputTrajectoryFile()
       ComputeConfidence()
       PublishGoalOdom()
Called By: FrameRecon()
Table Accessed: none
Table Updated: none
...
void FrameRecon::HandleGroundClouds(const sensor_msgs::PointCloud2 & vGroundRosData) {
...
void FrameRecon::HandleBoundClouds(const sensor_msgs::PointCloud2 & vBoundRosData) {
...
void FrameRecon::HandleObstacleClouds(const sensor_msgs::PointCloud2 & vObstacleRosData) {
...
void FrameRecon::ComputeConfidence(const pcl::PointXYZ & oCurrRobotPos,
...
void FrameRecon::PublishGridMap(){
...
void FrameRecon::PublishPlanNodeClouds(){
  //publish obstacle points
...
void FrameRecon::PublishPastNodeClouds(){
  //publish obstacle points
...
void FrameRecon::PublishGoalOdom(pcl::PointXYZ & oGoalPoint){
...
Others: none
*************************************************/
void FrameRecon::OutputCoverRateFile(const int & iTravelableNum){
...
void FrameRecon::OutputTrajectoryFile(const nav_msgs::Odometry & oTrajectory){
...
Others: none
*************************************************/
void FrameRecon::OutputScannedPCFile(pcl::PointCloud<pcl::PointXYZ> & vCloud){
